...
public class CannonView extends SurfaceView
    ...
    private void showGameOverDialog(final int messageId) {
        final AlertDialog.Builder diallogBuilder = new AlertDialog.Builder(getContext());
        diallogBuilder.setTitle(getResources().getString(messageId));
        diallogBuilder.setCancelable(false);
        diallogBuilder.setMessage(getResources().getString(R.string.results_format, shotsFired, totalElapsedTime));
        diallogBuilder.setPositiveButton(R.string.reset_game,
