...
public class ProductListViewAdapter extends BaseAdapter {
    ...
    public Object getItem(int position) {
        //Trả về dữ liệu ở vị trí 'position' của Adapter,
        // tương ứng là phần tử có chỉ số position trong listProduct
        return listProduct.get(position);
    }

    @Override
    public long getItemId(int position) {
        //Trả về một ID của từng phần tử
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View viewProduct;
        if (convertView == null) {
            viewProduct = View.inflate(parent.getContext(), R.layout.activity_xt_listview_items, null);
